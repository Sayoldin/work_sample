...
opts_knit$set(root.dir = "~/Dropbox/Bahar_Job/Example_viz/")
```

## Read data
### Load sample_info, a tab-delimited file
...
## Create a data fram to hold statistics
```{r}
diversity_data <-
...
# Kruska Wallis test 
## if microbial alpha diversity is different among human body areas
```{r}
